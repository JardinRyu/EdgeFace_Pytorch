...
from models.net import Bottleneck, EdgeFacenet
from models.net import FPN as FPN
from models.net import Context as Context
...
class Edgeface(nn.Module):
    ...
    def forward(self,inputs):
        ...
        # SSH
        feature1 = self.cm1(fpn[0])
        feature2 = self.cm2(fpn[1])
        feature3 = self.cm3(fpn[2])
        features = [feature1, feature2, feature3]
        #features = [fpn[0], fpn[1], fpn[2]]
